const POLICIES = [
  {
    ...
    detail:
      'เปิดจำหน่ายเข็มกลัดที่ระลึกของโรงเรียนสำหรับนักเรียนทุกระดับชั้น และรุ่น Limited Edition สุดพิเศษสำหรับพี่ ม.6 เพื่อเป็นสัญลักษณ์แห่งความภูมิใจและเกียรติยศของพวกเราทุกคน',
  ...
  },
  {
    num: '08',
    icon: '📱',
    title: 'ระบบแจ้งปัญหาและพื้นที่สร้างสรรค์ (Instagram)',
    hook: 'สื่อสารปลอดภัย สร้างสรรค์ ไม่แตกแยก',
    detail:
      'สร้างสรรค์พื้นที่สื่อสารออนไลน์ผ่าน Instagram โดยมีทีมแอดมินคอยคัดกรองข้อมูลอย่างเป็นระบบ เพื่อเป็นสื่อกลางในการรับฟังความคิดเห็น ส่งต่อข้อความ และสร้างความเข้าใจอันดีระหว่างนักเรียน โดยเน้นการสื่อสารที่ปลอดภัย สร้างสรรค์ และไม่ก่อให้เกิดความแตกแยก',
